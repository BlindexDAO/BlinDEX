...
export function load() {
  ...
  task("show:rsk-btc-usd").setAction(async (args, hre) => {
  ...
  task("update:rsk-btc-usd").setAction(async (args, hre) => {
  ...
  task("show:rsk-btc-usd-sovryn").setAction(async (args, hre) => {
    const updater = "0x9c385013670f34256450aba0ba7bd1b36ef02326";
  ...
  task("show:rsk-btc-usd-should-update").setAction(async (args, hre) => {
    const updater = "0x9c385013670f34256450aba0ba7bd1b36ef02326";
    const feed = SovrynSwapPriceFeed__factory.connect("0xAc78F96c68dBe1f1c93fdB0EFAc61355670e0285", await hre.ethers.getSigner(updater));
